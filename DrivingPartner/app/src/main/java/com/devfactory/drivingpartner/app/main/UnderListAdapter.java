 ...
 */
public class UnderListAdapter extends ArrayAdapter<SearchListItem> {
    ...
    public UnderListAdapter(Context context, int resource, ArrayList<SearchLocation> objects) {
